/**
 * Module: GaugeTextUtils - Shared text fitting and overlay helpers for gauge widgets
...
(function (root, factory) {
  ...
  else { (root.DyniModules = root.DyniModules || {}).DyniGaugeTextUtils = factory(); }
}(this, function () {
  "use strict";
  ...
  return { id: "GaugeTextUtils", create };
}));
