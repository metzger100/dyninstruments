...
(function (root, factory) {
  if (typeof define === "function" && define.amd) define([], factory);
    ...
    (root.DyniComponents = root.DyniComponents || {}).DyniRoutePointsMarkup = factory();
  }
})(this, function () {
  "use strict";
  ...
  function renderHeader(model, geometry, fit, htmlUtils) {
    ...
    return (
      "" +
      '<div class="dyni-route-points-header"' +
      htmlUtils.toStyleAttr(geometry.header.style) +
      ">" +
      '<div class="dyni-route-points-header-route"' +
      htmlUtils.toStyleAttr(geometry.header.routeNameStyle) +
      ">" +
      ...
      "</span>" +
      "</div>" +
      '<div class="dyni-route-points-header-meta"' +
      htmlUtils.toStyleAttr(geometry.header.metaStyle) +
      ">" +
    ...
    for (let i = 0; i < rows.length; i += 1) {
      ...
      const ordinalHtml = showOrdinal
        ? '<div class="dyni-route-points-ordinal"' +
          htmlUtils.toStyleAttr(geom.ordinalStyle) +
          ">" +
      ...
      html +=
        ...
        ">" +
        ordinalHtml +
        '<div class="dyni-route-points-middle"' +
        htmlUtils.toStyleAttr(geom.middleStyle) +
        ">" +
        '<div class="dyni-route-points-name"' +
        htmlUtils.toStyleAttr(geom.nameStyle) +
        ">" +
        ...
        "</span>" +
        "</div>" +
        '<div class="dyni-route-points-info"' +
        htmlUtils.toStyleAttr(geom.infoStyle) +
        ">" +
        '<span class="' +
        infoTextClasses.join(" ") +
        '"' +
        ...
        "</div>" +
        "</div>" +
        '<div class="dyni-route-points-marker-cell"' +
        htmlUtils.toStyleAttr(geom.markerStyle) +
        ">" +
        '<span class="' +
        markerClasses.join(" ") +
        '"' +
