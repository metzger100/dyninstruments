...
const { installUnitFormatFamilies } = require("./unit-format-families");
const { makeRouteContext } = require("./mapper-route-context");
    ...
    build(props) {
      ...
      const points =
        editingRoute && Array.isArray(editingRoute.points)
          ? editingRoute.points.map(function (/** @type {any} */ point, /** @type {number} */ index) {
              return {
