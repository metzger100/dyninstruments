...
describe("ThemeModel", function () {
  ...
  it("contains expected preset override spot values", function () {
    ...
    expect(model.getPresetBase("slim").strokeWeight).toBe(0.66);
    ...
    expect(model.getPresetBase("bold").strokeWeight).toBe(1.32);
    ...
    expect(model.getPresetBase("highcontrast").strokeWeight).toBe(1.32);
