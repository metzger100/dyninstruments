...
describe("config/components.js", function () {
  it("creates component registry from baseUrl", function () {
    ...
    expect(components.AisTargetLayout.deps).toEqual(["ResponsiveScaleProfile", "LayoutRectMath"]);
    ...
    expect(components.AisTargetHtmlFit.deps).toEqual(["ThemeResolver", "RadialTextLayout", "TextTileLayout", "AisTargetLayout", "HtmlWidgetUtils"]);
