...
describe("static cluster configs", function () {
  it("registers course/speed/default/wind/map/anchor definitions with expected defaults", function () {
    ...
    expect(byCluster.default.editableParameters.defaultLinearAlarmLowColor.default).toBe("#d9534a");
    expect(byCluster.default.editableParameters.defaultLinearWarningLowColor.default).toBe("#e0a92e");
    expect(byCluster.default.editableParameters.defaultLinearWarningHighColor.default).toBe("#e0a92e");
    expect(byCluster.default.editableParameters.defaultLinearAlarmHighColor.default).toBe("#d9534a");
    ...
    expect(byCluster.default.editableParameters.defaultRadialAlarmLowColor.default).toBe("#d9534a");
    expect(byCluster.default.editableParameters.defaultRadialWarningLowColor.default).toBe("#e0a92e");
    expect(byCluster.default.editableParameters.defaultRadialWarningHighColor.default).toBe("#e0a92e");
    expect(byCluster.default.editableParameters.defaultRadialAlarmHighColor.default).toBe("#d9534a");
