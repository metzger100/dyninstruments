...
describe("config/clusters/default.js", function () {
  ...
  it("registers the default instruments cluster with the approved editable contract", function () {
    ...
    expect(def.editableParameters.defaultLinearAlarmLowColor.default).toBe("#d9534a");
    expect(def.editableParameters.defaultLinearWarningLowColor.default).toBe("#e0a92e");
    expect(def.editableParameters.defaultLinearWarningHighColor.default).toBe("#e0a92e");
    expect(def.editableParameters.defaultLinearAlarmHighColor.default).toBe("#d9534a");
    ...
    expect(def.editableParameters.defaultRadialAlarmLowColor.default).toBe("#d9534a");
    expect(def.editableParameters.defaultRadialWarningLowColor.default).toBe("#e0a92e");
    expect(def.editableParameters.defaultRadialWarningHighColor.default).toBe("#e0a92e");
    expect(def.editableParameters.defaultRadialAlarmHighColor.default).toBe("#d9534a");
