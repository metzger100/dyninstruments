...
describe("XteDisplayWidget", function () {
  ...
  it("hides waypoint name before core metrics in constrained layouts", function () {
    ...
    const fillTexts = narrowCtx.calls.filter((/** @type {any} */ entry) => entry.name === "fillText");
