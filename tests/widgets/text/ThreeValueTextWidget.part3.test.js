...
describe("ThreeValueTextWidget", function () {
  ...
  it("increases compact text fill ratios within high, normal, and flat modes", function () {
    ...
    cases.forEach(function (item) {
      ...
      const compactCalls = renderCaptured(
        compactSpec,
        item.compact.width,
        item.compact.height,
        props,
      ...
      const largeCalls = renderCaptured(
        largeSpec,
        item.large.width,
        item.large.height,
        props,
      ...
      const compactRatio =
        ...
        item.usableHeight(
          item.compact.height,
          compactInsets,
          compactMode.secScale,
        );
      const largeRatio =
        parseFontPx(largeTarget.font) /
        item.usableHeight(item.large.height, largeInsets, largeMode.secScale);
