...
| TD-015 | 2026-05-26 | Retired file-size hotspot warning-tier debt after PLAN32 enforcement migration: `check:filesize` no longer reports warnings, and the gate now tracks only fail-closed `violations`/oneliner findings (`violations=0`, `onelinerFindings=0`). |
