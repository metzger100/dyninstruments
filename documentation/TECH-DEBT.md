...
| TD-011 | 2026-02-21 | Added fail-closed smell prevention program: `check:smells` (pattern + semantic contracts), falsy-default preservation, theme cache invalidation contract, stale dynamic key cleanup, and pre-push full-gate hook workflow. |
