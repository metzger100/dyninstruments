...
| TD-025 | Warn-tier legacy-support backlog | `check:patterns` (`2026-04-03`) reports 3 warn-tier `premature-legacy-support` findings in route-points helpers: `shared/widget-kits/nav/RoutePointsDomEffects.js` (lines 19, 71) and `shared/widget-kits/nav/RoutePointsRenderModel.js` (line 20). These fallbacks are intentionally conservative but should be narrowed once boundary guarantees are codified. | Low | Medium |
