...
- **What shared responsive compaction contract should layout owners follow?** → [shared/responsive-scale-profile.md](shared/responsive-scale-profile.md)
...
- **How does the CI performance gate compare against the core baseline?** → [guides/performance-gate.md](guides/performance-gate.md)
