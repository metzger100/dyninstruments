...
- `npm run check:all` completed successfully without threshold, suppression, or scope relaxation: 467 test files and
  2,060 tests passed in both the normal and coverage runs; coverage reached 92.28% statements and 93.26% lines.
